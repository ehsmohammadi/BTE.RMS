...
namespace BTE.RMS.Presentation.Theme.PersianControls
{
    /// <summary>
    ...
    public partial class PersianCalendar : UserControl
    {
        ...
        public static readonly DependencyProperty SelectedDateBackgroundProperty =
            DependencyProperty.Register("SelectedDateBackground", typeof(Brush), typeof(PersianCalendar), new UIPropertyMetadata(Brushes.Goldenrod));
        ...
        static string[] daysOfWeek = new string[] { "شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه" };
